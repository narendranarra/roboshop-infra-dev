...
/* 02 july session changed till that it is working fine
module "frontend" {
    #source = "../../terraform-aws-securitygroup"
    source = "git::https://github.com/narendranarra/terraform-aws-securitygroup.git?ref=main"
    project = var.project
...
# backend ALB accepting connections from VPN host on port 6379
...
# backend ALB accepting connections from VPN host on port 3306
...
# backend ALB accepting connections from VPN host on port 5672
